...
const PathsCard: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="group bg-gradient-to-b  from-gray-500 hover:from-yellow-500 to-black rounded-b-xl rounded-t-xl relative max-w-[500px] h-[120px] flex item-center overflow-hidden transition-transform duration-300 ease-linear transform hover:scale-105">
