      ...
      <MaxWidthWrapper className="relative">
        <div className="justify-center align-middle flex items-center">
          <div className="lg:max-w-[500px]"  >
            <div className="justify-center align-middle flex items-center pb-5" ><p className="text-white text-4xl">Welcome Back!</p></div>
            <div className="justify-center align-middle flex items-center w-70"><p className="text-white text-xl">Login to access your account and continue your learning journey</p></div>
            <div className="justify-center align-middle flex items-center  pt-5">
              <div className="block mx-auto md:max-w-[600px] lg:max-w-[500px] w-full 3xl:!max-w-[655px] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 ">
                ...
                <div className="text-dark flex justify-end py-5">Forget Password?</div>
                <Button className="w-full ">Login</Button>
                <div className="text-dark flex justify-center py-5">Don’t have an account? <span className="text-sky-600 pl-1">Register now</span></div>
