            ...
            <MaxWidthWrapper className="relative">
              <div className="justify-center align-middle flex items-center h-screen">
                <div className=" w-screen lg:max-w-[400px]"  >
                  ...
                  <div className=" text-subheading text-white text-center">Unlock a world of knowledge and begin your learning journey by creating your account</div>
                  ...
                  <div className="flex gap-2 pt-4 items-center">
                    ...
                    <div className="md:w-1/4 flex justify-start">
                      ...
                      <div className="text-dark flex justify-center py-5 text-sm">Already have an account? <span className="text-sky-600 cursor-pointer pl-1">Login now</span></div>
